...
func TestNewUnifiedScanResult(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers, XSS: xss})
...
func TestCorrelationSQLiWithServerHeaders(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers, SQLi: sqli})
...
func TestCorrelationCSRFWithMissingSameSite(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers, CSRF: csrf})
...
func TestCorrelationMultipleInjectionPoints(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, XSS: xss, SQLi: sqli})
...
func TestRiskScoreCalculation(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers, XSS: xss, SQLi: sqli})
...
func TestPriorityActions(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, SQLi: sqli})
...
func TestEmptyResultHandling(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: true})
...
func TestPassiveOnlyFlag(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: true, Headers: headers})
...
func TestErrorPropagation(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Errors: errors})
...
func TestCorrelationIDGeneration(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers, XSS: xss, CSRF: csrf})
...
func TestFindCookiesWithoutSameSite_NoneValue(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: target, PassiveOnly: false, Headers: headers})
...
func TestCalculateRiskScore_AllSeverityCombinations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, XSS: xss, SQLi: sqli})
...
func TestCalculateRiskScore_ZeroFindings(t *testing.T) {
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false})
	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, XSS: xss, SQLi: sqli, CMDi: cmdi})
			},
			category:         "injection",
			expectedMaxScore: 40,
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, CSRF: csrf})
			},
			category:         "csrf",
			expectedMaxScore: 20,
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, SSRF: ssrf})
			},
			category:         "ssrf",
			expectedMaxScore: 30,
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Redirect: redirect})
			},
			category:         "redirect",
			expectedMaxScore: 25,
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, WebSocket: websocket})
			},
			category:         "websocket",
			expectedMaxScore: 20,
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers})
			},
		...
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss, SQLi: sqli, CSRF: csrf})
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			findings: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, XSS: xss})
			}(),
	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, SQLi: sqli})
			},
		...
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, CMDi: cmdi})
			},
		...
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, SSTI: ssti})
			},
...
func TestGeneratePriorityActions_MixedSeverityFindings(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, XSS: xss, SQLi: sqli, CSRF: csrf})
...
func TestGeneratePriorityActions_AllVulnerabilityTypes(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss, SQLi: sqli, CSRF: csrf, SSRF: ssrf, Redirect: redirect, CMDi: cmdi, SSTI: ssti})
...
func TestGeneratePriorityActions_ActionListTruncation(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss, SQLi: sqli, CSRF: csrf, Redirect: redirect, CMDi: cmdi, SSTI: ssti})
...
func TestCorrelateFindings_XSSWithMissingCSP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss})
...
func TestCorrelateFindings_SQLiWithServerVersionHeader(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, SQLi: sqli})
...
func TestCorrelateFindings_CSRFWithMissingSameSiteCookie(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, CSRF: csrf})
...
func TestCorrelateFindings_CMDiWithSSRF(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, SSRF: ssrf, CMDi: cmdi})
...
func TestCorrelateFindings_CMDiWithSQLi(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, SQLi: sqli, CMDi: cmdi})
	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss})
			},
		},
		{
		...
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, CSRF: csrf})
			},
		},
		{
			...
			setupFunc: func() *UnifiedScanResult {
				...
				return NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, XSS: xss, SQLi: sqli})
			},
		},
	}
...
func TestGenerateSummary_AllScannerResultTypes(t *testing.T) {
	...
	result := NewUnifiedScanResult(ScanResultOptions{Target: "http://test.com", PassiveOnly: false, Headers: headers, XSS: xss, SQLi: sqli, CSRF: csrf, SSRF: ssrf, Redirect: redirect, CMDi: cmdi, PathTraversal: pathtraversal, SSTI: ssti, WebSocket: websocket})
