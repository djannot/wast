...
func TestRobotsData_IsAllowed_Wildcards(t *testing.T) {
	tests := []struct {
		name     string
		robots   *RobotsData
		path     string
		...
		{
			name: "disallow all images with wildcard",
			robots: &RobotsData{
		...
		{
			name: "allow specific image type, disallow all",
			robots: &RobotsData{
				Disallow: []string{"/images/*"},
				Allow:    []string{"*.png"},
			},
		...
		{
			name: "disallow gif files with end anchor",
			robots: &RobotsData{
				Disallow: []string{"/*.gif$"},
			},
			path:     "/image.gif",
		...
		{
			name: "allow gif.bak even with gif disallowed",
			robots: &RobotsData{
				Disallow: []string{"/*.gif$"},
			},
			path:     "/image.gif.bak",
		...
		{
			name: "complex wildcard pattern - disallow",
			robots: &RobotsData{
		...
		{
			name: "complex wildcard pattern - allow different action",
			robots: &RobotsData{
				Disallow: []string{"/admin/*/edit.*"},
			},
			path:     "/admin/users/view.php",
			expected: true,
		},
		{
			name: "end anchor exact path match - disallow",
			robots: &RobotsData{
		...
		{
			name: "end anchor - allow path with suffix",
			robots: &RobotsData{
				Disallow: []string{"/checkout$"},
			},
		...
		{
			name: "multiple wildcards - disallow",
			robots: &RobotsData{
		...
		{
			name: "wildcard with allow override",
			robots: &RobotsData{
				Disallow: []string{"/private/*"},
				Allow:    []string{"/private/public/*"},
			},
			path:     "/private/public/docs/readme.txt",
			expected: true,
		},
		{
			name: "wildcard - disallow when allow doesn't match",
			robots: &RobotsData{
				Disallow: []string{"/private/*"},
				Allow:    []string{"/private/public/*"},
			},
