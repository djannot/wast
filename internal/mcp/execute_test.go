...
func TestExecuteScan(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := executeScan(ctx, tt.target, tt.timeout, tt.safeMode, tt.verifyFindings, false, 2, 5, 5, nil, authConfig, rateLimitConfig, nil, nil, "")
...
func TestExecuteScanWithAuth(t *testing.T) {
	...
	result := executeScan(ctx, "https://example.com", 30, true, false, false, 2, 5, 5, nil, authConfig, rateLimitConfig, nil, nil, "")
