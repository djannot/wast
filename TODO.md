...
- ~~Add WebGoat as a third benchmark target (Java/Spring, different session patterns)~~
  **DONE** — `docker-compose.webgoat.yml`, `test/integration/webgoat/webgoat_test.go`, `make test-webgoat`, and optional CI job added in PR #296; covers SQLi, XSS, PathTraversal, Headers assertions plus NoSQLi/XXE zero-false-positive checks.
