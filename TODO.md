...
- [ ] **Permission checker false positives** — Matching "sh " in "refresh", "token" in crypto descriptions, "eval" in "relevant". Switch from substring matching to whole-word matching or context-aware patterns. This is the #1 noise source (56 findings on a single server, most are junk).
